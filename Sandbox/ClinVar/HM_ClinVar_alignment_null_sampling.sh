...
#$ -pe shmem 16
#$ -t 1-22 -tc 16
#$ -N ClinVar_alignment_null_sampling
...
Rscript --vanilla /well/lindgren/George/Code/Interspecific_mapping/ClinVar/HM_ClinVar_alignment_null_sampling.R  \
...
"/well/lindgren/George/Data/ClinVar/formatted/ClinVar_mouse_mapping_null_sampling_Hchr""$SGE_TASK_ID"".csv" \
"$SGE_TASK_ID"
