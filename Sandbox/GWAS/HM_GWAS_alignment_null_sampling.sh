...
#$ -pe shmem 16
#$ -t 1-22 -tc 16
#$ -N GWAS_alignment_null_sampling
...
Rscript --vanilla /well/lindgren/George/Code/Interspecific_mapping/GWAS/HM_GWAS_alignment_null_sampling.R  \
"/well/lindgren/George/Data/GWAS/formatted/GWAS_mouse_mapping_Hchr""$SGE_TASK_ID"".csv" \
...
"/well/lindgren/George/Data/GWAS/formatted/GWAS_mouse_mapping_null_sampling_Hchr""$SGE_TASK_ID"".csv" \
"$SGE_TASK_ID"
