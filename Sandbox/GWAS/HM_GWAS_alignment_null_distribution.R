...
dt_list <- list()
for (i in 1:22){
  dt_list[[i]] <- fread(paste0("~/Dropbox/PhD/Data/GWAS/formatted/GWAS_mouse_mapping_null_sampling_Hchr", i, ".csv"))
}
dt <- do.call("rbind", dt_list)
cv <- fread("~/Dropbox/PhD/Data/GWAS/formatted/GWAS_mouse_mapping.csv")
...
fwrite(out2, "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/GWAS_z_scores_v2.csv")
