...
# reg.build.heart.gff <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/raw/homo_sapiens.GRCh38.heart.Regulatory_Build.regulatory_activity.20190329.gff.gz"
# reg.build.kidney.gff <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/raw/homo_sapiens.GRCh38.kidney.Regulatory_Build.regulatory_activity.20190329.gff.gz"
# reg.build.spleen.gff <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/raw/homo_sapiens.GRCh38.spleen.Regulatory_Build.regulatory_activity.20190329.gff.gz"
# gencode.gtf <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/raw/Homo_sapiens.GRCh38.101.gtf.gz"
# tad.file <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/raw/Human_TAD_boundries_liver_ESC_25kb_GRCh38.csv"
# chr.nbp.file <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/formatted/h.sap_reference_Ensembl_GRC38_bp_counts.bed"
# N.mask.file <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/formatted/h.sap_reference_Ensembl_GRC38_N_mask.bed"
# out.file <- "~/Dropbox/PhD/Data/Interspecific_SNV_mapping/workflow_v1/formatted/h.sap_GRC38_v101_whole_genome_features.csv"
# chr <- as.character(17)

# reg.build.heart.gff <- "/well/lindgren/George/Data/Mapping_v1/raw/homo_sapiens.GRCh38.heart.Regulatory_Build.regulatory_activity.20190329.gff.gz"
# reg.build.kidney.gff <- "/well/lindgren/George/Data/Mapping_v1/raw/homo_sapiens.GRCh38.kidney.Regulatory_Build.regulatory_activity.20190329.gff.gz"
# reg.build.spleen.gff <- "/well/lindgren/George/Data/Mapping_v1/raw/homo_sapiens.GRCh38.spleen.Regulatory_Build.regulatory_activity.20190329.gff.gz"
# gencode.gtf <- "/well/lindgren/George/Data/Mapping_v1/raw/Homo_sapiens.GRCh38.101.gtf.gz"
# N.mask.file <- "/well/lindgren/George/Data/Mapping_v1/formatted/h.sap_reference_Ensembl_GRC38_N_mask.bed"
# chr.nbp.file <- "/well/lindgren/George/Data/Mapping_v1/formatted/h.sap_reference_Ensembl_GRC38_bp_counts.bed"
# tad.file <- "/well/lindgren/George/Data/Mapping_v1/raw/Human_TAD_boundries_liver_ESC_25kb_GRCh38.csv"
# out.file <- "/well/lindgren/George/Data/Mapping_v1/formatted/h.sap_GRC38_v101_whole_genome_features_multicell_chr3.csv"
# chr <- as.character(3)
...
### EXPORT 
fwrite(annotation, out.file, compress == "gzip", append = T)
