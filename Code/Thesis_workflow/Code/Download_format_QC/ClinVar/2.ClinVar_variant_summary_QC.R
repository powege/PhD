...
### ARGUMENTS
raw.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/ClinVar/Raw/variant_summary.txt.gz"
qced.file <- "/well/lindgren/George/Data/Thesis_workflow/Data/ClinVar/Formatted/ClinVar_GRCh38_germline_pathogenic_benign_snps.vcf"
