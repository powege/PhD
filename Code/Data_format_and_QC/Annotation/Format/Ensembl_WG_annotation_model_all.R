...
### Outouts all seqences regardless of overlap
...
promoter_pos <- promoter_pos[,c("chromosome", "start", "end", "category", "strand")]
...
promoter_flank_pos <- promoter_flank_pos[,c("chromosome", "start", "end", "category", "strand")]
...
enhancer_pos <- enhancer_pos[,c("chromosome", "start", "end", "category", "strand")]
...
CTCF_binding_pos <- CTCF_binding_pos[,c("chromosome", "start", "end", "category", "strand")]
...
TF_binding_pos <- TF_binding_pos[,c("chromosome", "start", "end", "category", "strand")]
