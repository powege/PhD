### FIGURE 5 -- 
# spit IMPC knockouts into three groups: 
# knockouts that have been throught the core adult pipeline.
# knockouts that are subviable
# knockouts that are preweaning lethal
# knockputs that are e9.5 lethal
# knockputs that are e12.5 lethal
# knockputs that are e14.5 lethal
# knockputs that are e18.5 lethal
