...
# human
Rscript --vanilla /well/lindgren/George/Workflows/NC_constraint/Code/Data_format_and_QC/Figures_and_Tables/Figure_annotation_CpG_composition.R \
"$SGE_TASK_ID" \
...
/well/lindgren/George/Data/NC_constraint/Figures_and_tables/Figure_annotation_CpG_proportion_human_chr"$SGE_TASK_ID".csv
...
/well/lindgren/George/Data/NC_constraint/Figures_and_tables/Figure_annotation_CpG_proportion_mouse_chr"$SGE_TASK_ID".csv
