...
h_dt <- fread("~/Dropbox/PhD/Data/NC_constraint/Figures_and_tables/Raw/Figure_annotation_SNV_proportion_human.csv")
m_dt <- fread("~/Dropbox/PhD/Data/NC_constraint/Figures_and_tables/Raw/Figure_annotation_SNV_proportion_mouse.csv")
...
ggsave("~/Dropbox/PhD/Data/NC_constraint/Figures_and_tables/Figure_ann_SNV_per_kb.jpg", plot = p1, height = 5, width = 7)


#####

# p <- ggplot(plot_dt, aes(x=category, y=n_SNV_kb, fill=Species)) +
#   geom_boxplot() +
#   coord_flip()
# p
