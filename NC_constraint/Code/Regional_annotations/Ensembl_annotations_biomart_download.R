...
# H_exon.pos <- exon_coords(species = "hsapiens_gene_ensembl", chr = c(1:22, "X"))

M_UTR.pos <- UTR_coords(species = "mmusculus_gene_ensembl", chr = c(1:19, "X"))
# H_UTR.pos <- UTR_coords(species = "hsapiens_gene_ensembl", chr = c(1:22, "X"))
...
# fwrite(H_exon.pos, "../../Data/Ensembl/H_exon_POS.csv")
fwrite(M_UTR.pos, "~/Dropbox/PhD/Data/Ensembl/BioMart/M_UTR_POS.csv")
# fwrite(H_UTR.pos, "../../Data/Ensembl/H_UTR_POS.csv")
...
# x <- listAttributes(ensembl, page = "structure")



x <- fread("~/Dropbox/PhD/Data/Ensembl/BioMart/M_exon_POS.csv")
