...
for (chr in 1:19){
  ...
  ref_file <- paste0("~/Dropbox/PhD/Data/Ensembl/Reference/Formatted/Mouse_REF_sm_Ensembl_GRCm38_v94_chr", chr, ".txt")
  vcf_file <- paste0('~/Dropbox/PhD/Data/MGP/vcf_QCed_VEP/MGP_v5_snps_QCed_hom_chr', chr, '.vcf')
  out_file <- paste0('~/Dropbox/PhD/Data/NC_constraint/SNV_rates/MGP_k7_SNV_rate_table_chr', chr, '.csv')
