...
# import
out <- fread("/well/lindgren/George/Data/NC_constraint/Ensembl_annotation_POS/intron_POS_ID_long.csv", header = F)
...
fwrite(df, paste0("/well/lindgren/George/Data/NC_constraint/Ensembl_annotation_POS/FRACTION_intron_POS_short.csv"), col.names = F)
