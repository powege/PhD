...
H_dt_list <- list()
for (chr in 1:19){
  H_dt_list[[chr]] <- fread(paste0("~/Dropbox/PhD/Data/NC_constraint/SNV_rates/1000GP_7mer_SNV_rates_chr", chr, ".table"))
}
...
### EXPORT
fwrite(H_out, "~/Dropbox/PhD/Data/NC_constraint/SNV_rates/1000GP_7mer_SNV_rates.table")
...
H_um_dt_list <- list()
for (chr in 1:19){
  H_um_dt_list[[chr]] <- fread(paste0("~/Dropbox/PhD/Data/NC_constraint/SNV_rates/1000GP_7mer_SNV_rates_unmasked_chr", chr, ".table"))
}
...
### EXPORT
fwrite(H_um_out, "~/Dropbox/PhD/Data/NC_constraint/SNV_rates/1000_7mer_SNV_rates_unmasked.table")
